...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        PlatformSetting::current()->forceFill([
            ...
            'seo_site_name' => 'Teach4Free',
            'seo_default_meta_title' => 'Teach4Free - Learn and teach for free',
            'seo_default_meta_description' => 'A global community where people teach and learn online for free, without payments, credits or commissions.',
            'seo_default_robots' => 'index,follow',
            'seo_default_og_image_path' => null,
            'seo_enable_sitemap' => true,
            'seo_enable_structured_data' => true,
            'seo_search_indexing_enabled' => true,
            'updated_by' => $admin->id,
        ])->save();
        ...
        foreach ($scenarios as $key => $scenario) {
            ...
            $profile = TeacherProfile::updateOrCreate(
                ...
                [
                    ...
                    'show_badges' => $key !== 'new',
                    'show_reviews' => $key !== 'attention',
                    'show_reputation_summary' => $key !== 'attention',
                    'show_completed_sessions_count' => $key !== 'new',
                    'show_students_helped_count' => $key === 'excellent',
                    'show_teaching_hours' => $key !== 'new',
                    'show_location' => $key !== 'attention',
                    'show_availability_summary' => $key !== 'reliable',
